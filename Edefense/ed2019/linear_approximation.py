...
def main():
    ...
    path = "C:/Users/6969p/Documents/GitHub/hattori_sens/Edefense/ed2019/"
    sens_no = 11   # calibration data
    read_name_cal = "calibration_result_after_Edefense2019/XYS200_DPSD2018_no"+str(sens_no)+"_121.csv"
    # experimental data
    read_name_exp = "*raw/20191203/*ch09.csv"
    ...
    df0.fillna(0)
    df0.columns = ["Xtrue", "Ytrue", "X1", "Y1", "X2", "Y2"]
    ...
    for i in range(len(csvs)):
        ...
        df2.to_csv(path+"corrected_reults/"+filename+"_out.csv")
