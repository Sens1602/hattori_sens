...
// Sample clock speed for a 32-bit processor
    ...
    #define RUN_AT_48MHZ
    // Indicates that the PIC32 clock is running at 40 MHz
     // #define RUN_AT_40MHZ
...
*/
        ...
        #define SPI_FREQUENCY			(10000000)
            ...
            // Description: SD-SPI Chip Select Output bit
            #define SD_CS               PORTBbits.RB6			// ピンを変更
            // Description: SD-SPI Chip Select TRIS bit
            #define SD_CS_TRIS          TRISBbits.TRISB6
            
            // Description: SD-SPI Card Detect Input bit
            #define SD_CD               PORTBbits.RB2			// ピンを変更
            // Description: SD-SPI Card Detect TRIS bit
            #define SD_CD_TRIS          TRISBbits.TRISB2

            // Description: SD-SPI Write Protect Check Input bit
              #define SD_WE               PORTBbits.RB2			// ピンを変更
            // Description: SD-SPI Write Protect Check TRIS bit
