...
#define SD_CD           PORTAbits.RA8
#define SD_CD_TRIS      TRISAbits.TRISA8
#define SD_WE           PORTAbits.RA8
#define SD_WE_TRIS      TRISAbits.TRISA8
...
#define SPIIN           TRISCbits.TRISC5
#define SPIOUT          TRISCbits.TRISC3
