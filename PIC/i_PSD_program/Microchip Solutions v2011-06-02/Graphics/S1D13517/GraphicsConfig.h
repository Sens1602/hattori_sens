...
//#define USE_ALPHABLEND			// Enable Alpha Blending
#define USE_GRADIENT          // Enable Gradient Colors
...
/*********************************************************************
* Overview: Alpha Blending enables the use of transparency and the 
* effect of layers. Only available on S1D13517
********************************************************************/
