...
*/
    ...
    !defined(MULTI_MEDIA_BOARD_DM00123)     
	#error "Error: Graphics Hardware Platform is not defined! One of the following boards (GFX_PICTAIL_V3, GFX_PICTAIL_V2, PIC24FJ256DA210_DEV_BOARD, MULTI_MEDIA_BOARD_DM00123) must be defined.
#endif
...
/*
    ...
    * MULTI_MEDIA_BOARD_DM00123 - MultiMedia Expansion Board (DM320005)
...
/*
    ...
    2. Controller that drives the RGB Glass directly - these are display 
       ...
       When using MicrochipGraphicsModule required parameters:
       ...
       When using MicrochipGraphicsModule Optional parameters:       
...
*********************************************************************/
	...
	// optimum (fastest) timing requirement for your interface. 
        ...
        #error "Set the correct inteface timing for Epson Controller"
        #define PMP_DATA_SETUP_TIME                (xx)    
        #define PMP_DATA_WAIT_TIME                 (xx)  // See Epson S1D13517 data sheet for details
        #define PMP_DATA_HOLD_TIME                 (x)    
        ...
        #error "Set the correct inteface timing for Epson Controller"
        #define EPMPCS1_DATA_SETUP_TIME             (xx)    
        #define EPMPCS1_DATA_WAIT_TIME              (xx)  // See Epson S1D13517 data sheet for details
        #define EPMPCS1_DATA_HOLD_TIME              (x)    
...
// end of #if defined (GFX_PICTAIL_V3)  
...
*/
    ...
    #define DisplayBacklightOn()        LATDbits.LATD0 = 0
    #define DisplayBacklightOff()       LATDbits.LATD0 = 1   
// end of #elif defined (MULTI_MEDIA_BOARD_DM00123)
...
*/
    ...
    // end of #if defined (GFX_USE_DISPLAY_CONTROLLER_LGDP4531)
    ...
    #elif defined (GFX_USE_DISPLAY_CONTROLLER_SSD1906)
            ...
            #endif
    // end of #elif defined (GFX_USE_DISPLAY_CONTROLLER_SSD1906)        
    #endif
...
*/
	...
	*********************************************************************/
	...
	/* ----------------------------------------- */
	#elif defined (GFX_PICTAIL_V3) // && defined (EXPLORER_16) || PIC32 Starter Kits 
	/* ----------------------------------------- */
	...
	#endif //#elif defined (GFX_PICTAIL_V3) 
...
*/
	...
	* PIC24FJ256DA210 Development Board and MULTI_MEDIA_BOARD_DM00123
	*********************************************************************/
