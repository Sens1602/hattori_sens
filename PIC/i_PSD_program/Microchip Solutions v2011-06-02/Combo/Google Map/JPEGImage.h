...
// Definition for the function implemented in the external memory driver must be HERE:
    ...
    #define USE_JPEG_EDS			// uncomment this line if JPEG images are in EDS memory (RAM, internal PSV Flash, or external EPMP)

// JPEG file image structure for external and interanal memories
// See Primitive.h for BITMAP_FLASH and BITMAP_EXTERNAL info
    #define JPEG_FLASH      IMAGE_FLASH
    #define JPEG_EXTERNAL   IMAGE_EXTERNAL
    #define JPEG_EDS		GFX_IMAGE_HEADER 
...
// Valid values of the first field for JPEG_FLASH and JPEG_EXTERNAL structures
    ...
    #define FILE_JPEG_EDS		4	// the JPEG file is located in RAM (EDS) memory (RAM, or external EPMP)
