/*********************************************************************
 *
 *   HID Device Bootloader Firmware for PIC18F47J53 Family Devices
 *
 *********************************************************************
 * FileName:        Boot47J53Family.c
...
#define ConfigWordsSectionLength		0x08	//8 bytes worth of Configuration words on the PIC18F47J53 family devices

#if defined(__18F47J53)||defined(__18F27J53)
	#define MaxPageToEraseNoConfigs		126		 //Last page of flash on the PIC18F47J53, which does not contain the flash configuration words.
	#define MaxPageToEraseWithConfigs	127		 //Page 127 contains the flash configurations words on the PIC18F47J53.
	...
	#define ConfigWordsStartAddress		0x01FFF8 //0xXXXF8 is CONFIG1L on PIC18F47J53 family devices
#elif defined(__18F46J53)||defined(__18F46J53)
	#define MaxPageToEraseNoConfigs		94		 //Last page of flash on the PIC18F47J53, which does not contain the flash configuration words.
	#define MaxPageToEraseWithConfigs	95		 //Page 127 contains the flash configurations words on the PIC18F47J53.
	...
	#define ConfigWordsStartAddress		0x017FF8 //0xXXXF8 is CONFIG1L on PIC18F47J53 family devices
#endif
...
#define	FlashBlockSize				0x40	//For PIC18F47J53 family devices, a flash block is 64 bytes
