...
{
	_asm
	bsf		TRISB, 4, 0			//Address: 0x00		//Configure RB4 as input pin (not strictly necessary since reset state is already = 1)
...
BootEntryIOCheck:
    ...
    btfss	PORTB, 4, 0			//Address: 0x0C		//Check RB4 I/O pin state	
