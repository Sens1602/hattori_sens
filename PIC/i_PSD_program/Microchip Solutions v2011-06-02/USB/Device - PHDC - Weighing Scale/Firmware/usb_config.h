...
/* PHDC */
#define PHDC_INTF_ID 0x0
#define PHDC_DATA_EP 2
#define PHDC_INT_EP 1
#define PHDC_DATA_OUT_EP_SIZE      64
#define PHDC_DATA_IN_EP_SIZE      64
#define PHDC_INT_IN_EP_SIZE      8


//#define USE_PHDC_INTERRUPT_ENDPOINT
