...
ROM USB_DEVICE_DESCRIPTOR device_dsc=
{
    ...
    0x04D8,                 // Vendor ID
    0x0E40,                 // Product ID: PHDC - Weigh Scale demo. 
...
ROM BYTE configDescriptor1[]={
    ...
    USB_DESCRIPTOR_CONFIGURATION,                // CONFIGURATION descriptor type
        ...
        61,0,                   // Total length of data for this cfg
    #else 
        60,0,
    #endif 
	...
	0x04,					//size
	0x20,					//Descriptor type PHDC Class-Function Descriptor
	0x02,					//Data messaging format code not defined by vendor. DATA FORMAT--PHDC_11073_20601
	0x00,					//
...
/* Endpoint Descriptor */
	...
	0x04,		//size
	0x21,		//PHDC_QOS_DESCRIPTOR
	0x01,
	0x08,		//BULK IN qos

    /* Endpoint Descriptor */
    //sizeof(USB_EP_DSC),DSC_EP,_EP02_OUT,_BULK,PHDC_DATA_OUT_EP_SIZE,0x00,
    0x07,/*sizeof(USB_EP_DSC)*/
    USB_DESCRIPTOR_ENDPOINT,    //Endpoint Descriptor
...
{'P','H','D','C',' ','W','e','i','g','h',' ','S','c','a','l','e',' ','D','e','m','o'}
};
