The SimpleWinUSBDemo.exe program was written in Microsoft Visual C++ 2005 Express Edition.
...
3. http://connect.microsoft.com (must get passport login and join the correct group)
