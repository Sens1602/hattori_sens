 ...
 *
 * Note:   			Reports of data should be sent to the host matching the Report Descriptor.
 ...
 *					format:
 *					         
 *	//Report format for an example multi-touch device, which can support up to two
...
{   
    ...
    if(HIDTxHandleBusy(lastTransmission) == 0)		
    {
		...
		//Report ID is 0x01 for contact information reports (based on report descriptor)
		...
		//Always make sure that the HIDTxHandleBusy() returned false before calling
...
/********************************************************************
 * Function:        void MultiTouchGetReportHandler(void)
 *
 * PreCondition:    None
 *
 * Input:           None
...
void MultiTouchGetReportHandler(void)
{
	...
	{
		static WORD FeatureReport = 0x0202;
