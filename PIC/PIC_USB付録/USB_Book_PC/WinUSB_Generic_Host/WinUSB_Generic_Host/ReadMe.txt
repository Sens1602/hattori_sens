========================================================================
    アプリケーション: WinUSB_Generic_Host プロジェクトの概要
========================================================================

この WinUSB_Generic_Host アプリケーションは、AppWizard により作成されました。  

このファイルには、WinUSB_Generic_Host 
アプリケーションを構成する各ファイルの内容の概要が含まれています。

WinUSB_Generic_Host.vcxproj
...
WinUSB_Generic_Host.vcxproj.filters
...
StdAfx.h、StdAfx.cpp
    これらのファイルは、WinUSB_Generic_Host.pch 
