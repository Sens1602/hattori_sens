...
ROM USB_DEVICE_DESCRIPTOR device_dsc=
{
    ...
    0xEF,	//00,                   // Class Code
    0x02,	//00,                   // Subclass code
    0x01,	//00,                   // Protocol code
...
ROM BYTE configDescriptor1[]={
	...
	0x02,   //COMM_INTF, // bInterfaceClass of the first interface 
	0x00,   //ABSTRACT_CONTROL_MODEL, // bInterfaceSubclass of the first interface 
	0x00,   //V25TER, // bInterfaceProtocol of the first interface 
	0, 		// Interface string index 							
